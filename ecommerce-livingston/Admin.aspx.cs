    ...
    public partial class Admin : System.Web.UI.Page
    {
        ...
        private void CargarArticulos()
        {
            try
            {
                ...
                if (Session["listaArticulosAdmin"] ==null)
                    Session.Add("listaArticulosAdmin", new List<Articulo>());

                Session["listaArticulosAdmin"] = Articulos;
        ...
        protected void btnLimpiarFiltrosPedidos_Click(object sender, EventArgs e)
        {
            try
            {
                txtFiltroIdUser_Pedido.Text = "";
                txtFiltroIdPedido_Pedido.Text = "";
                txtFiltroNombreUsuario_Pedido.Text = "";
                txtFiltroFecha.Text = "";
                CargarPedidos();
            }
            catch (Exception ex)
        ...
        private List<Articulo> filtrarLista(object param, string tipoParam = null)
        {
            try
            {
                ...
                List<Articulo> listaPrincipal = (List<Articulo>)Session["listaArticulosAdmin"];
